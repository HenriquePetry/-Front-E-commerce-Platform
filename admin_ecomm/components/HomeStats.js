    ...
    <div>
      ...
      <div className="tiles-grid">
        <div className="tile">
          ...
          <div className="tile-desc">{ordersToday.length} Pedidos - Hoje</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Semanal</h3>
          <div className="tile-number">{ordersWeek.length}</div>
          <div className="tile-desc">{ordersWeek.length} Pedidos - Semana</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Mensal</h3>
          <div className="tile-number">{ordersMonth.length}</div>
          <div className="tile-desc">{ordersMonth.length} Pedidos - Mês</div>
        </div>
      </div>
      <h2>Receita</h2>
      <div className="tiles-grid">
